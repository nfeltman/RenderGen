...
withtype   cont = (var, (value1,value2) Contexts.doubleEntry) Contexts.context
...
fun eval1 env (E1 exp) = evalF env eval1 Contexts.extendLookup1 V1 V1unwrap exp
  | eval1 env (E1next e) = V1next (eval2 env e)
  | eval1 env (E1hold e) = holdGeneral (eval1 env e)
	
and eval2 env (E2 exp) = evalF env eval2 Contexts.extendLookup2 V2 (fn (V2 v) => v) exp
