...
fun handleHold (T1 (TFprim t)) = T1fut (T2 (TFprim t))
  | handleHold _ = raise TypeError 

in
  
fun typeCheck1 gamma (E1 exp) = typeCheck gamma typeCheck1 extendLookup1 T1 Tunwrap t1eq subst1 exp
  | typeCheck1 gamma (E1next e) = T1fut (typeCheck2 gamma e)
  | typeCheck1 gamma (E1hold e) = handleHold (typeCheck1 gamma e)
	
and typeCheck2 gamma (E2 exp) = typeCheck gamma typeCheck2 extendLookup2 T2 (fn (T2 t) => t) t2eq subst2 exp
