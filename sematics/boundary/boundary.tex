...
\begin{mathpar}
\infertypeswor [\to I]		{\Gamma \vdash {\fix ux{e}} \colfunsym {A \to B}}	{\types [\Gamma, u \colfunsym {A \to B},\col x A] {e} B} 							\and
\infertypeswor [\to E]		{\types {\app {f}{e}} {B}}							{\Gamma \vdash {f} \colfunsym {A \to B} & \ty {e} A} 					\and
...
\infertypeswor [\fut E]		{\ty {\letfin u f e} B}								{\Gamma \vdash \colfun f {A \to B} w 
																				&\ty [,\colfun u {A \to B} w] e B } 					\and
