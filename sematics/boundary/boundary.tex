...
\begin{mathpar}
\infertypeswor [+ E]		{\ty {\ifthen{e_1}{e_2}{e_3}} A}					{\ty {e_1}\rmbool & \ty{e_2} A & \ty{e_3} A}
\end{mathpar}
\end{framed}
...
\infertypeswor [\fut E]		{\typestwo {\letin x {e_1} {e_2}} B}				{\Gamma \vdash \colfun {e_1} {A \to B} \bbtwo 
																				&\typestwo [\Gamma,\colfun x {A \to B} \bbtwo] {e_2} B } 					\and
\end{mathpar}
\end{framed}
...
\infer {\btyw {\letin x {e_1} {e_2}} {B} {\tau_1 \times \tau_2}} 
	{\btyw {e_1} A {\tau_1} 
	&\btyw [\Gamma,\btj x A w \rmunit] {e_2} B {\tau_2}}
\end{mathpar}
