...
like splitting, partition an input program into static and dynamic components.  
...
allowing more efficient specialization of programs with 
...
That said, unlike splitting, where the goal is to emit code where first stage results
