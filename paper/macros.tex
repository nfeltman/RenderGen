...
%inference extension
\newcommand {\infertypesone} [3] [\mathrm{NONAME}]{ \infer [#1\text{-}\bbone] {#2}{#3}}
\newcommand {\infertypestwo} [3] [\mathrm{NONAME}]{ \infer [#1\text{-}\bbtwo] {#2}{#3}}
\newcommand {\inferreduceone} [3] [\mathrm{NONAME}]{ \infer [#1\Downarrow_\bbone] {#2}{#3}}
\newcommand {\inferreducetwo} [3] [\mathrm{NONAME}]{ \infer [#1\Downarrow_\bbtwo] {#2}{#3}}
\newcommand {\infersplitone} [3] [\mathrm{NONAME}]{ \infer [#1 \overset{\bbone}\rightsquigarrow] {#2}{#3}}
\newcommand {\infersplittwo} [3] [\mathrm{NONAME}]{ \infer [#1 \overset{\bbtwo}\rightsquigarrow] {#2}{#3}}
