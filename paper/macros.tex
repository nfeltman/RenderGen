...
\newcommand {\bbonep} {\ensuremath{\mathbbm{1P}}}
\newcommand {\bbonem} {\ensuremath{\mathbbm{1M}}}
...
{ 
	...
	\newcommand {\dothen} [3] {{\tt do}~{##1} ~{\tt then}~{##2}~{\tt =>}~{##3}}
	\newcommand {\lam} [3] {\lambda{##1}\mathrm{:}{##2}.{##3}}
	\newcommand {\valprod} [2] {({##1},{##2})}
	\newcommand {\projbind} [1] {\letin{l_{##1}}{\pi_{##1} l}{r_{##1}}}
	\newcommand {\mval} [2] {{\tt mv(}{##1}{\tt ;}{##2}{\tt )}}
}
{ }

\newenvironment{abstrsyn}
{ 
	\renewcommand {\pause} [1] {{\tt hold(}##1{\tt )}}
	\renewcommand {\next} [1] {{\tt next(}##1{\tt )}}
	\renewcommand {\prev} [1] {{\tt prev(}##1{\tt )}}
	\newcommand {\monoTerm} [1] {{\tt mono(}##1{\tt )}}
	\newcommand {\inl} [2] [] {{\tt inl}_{##1}{\tt(}{##2}{\tt )}}
	\newcommand {\inr} [2] [] {{\tt inr}_{##1}{\tt(}{##2}{\tt )}}
	\newcommand {\pio} [1] {{\tt pi1(}##1{\tt )}}
	\newcommand {\pit} [1] {{\tt pi2(}##1{\tt )}}
	\newcommand {\roll} [2] [] {{\tt roll}_{##1}{\tt(}##2{\tt )}}
	\newcommand {\unroll} [1] {{\tt unroll(}##1{\tt )}}
	\newcommand {\lifttag} [1] {{\tt lifttag(}##1{\tt )}}
	\newcommand {\push} {{\tt unroll}}
	\newcommand {\letin} [3] {{\tt let(}{##2}{\tt ;}{##1}.{##3}{\tt )}}
	\newcommand {\letmono} [3] {{\tt letm(}{##2}{\tt ;}{##1}.{##3}{\tt )}}

	\newcommand {\talllet} [3] {\begin{array}{@{}l@{}} {\tt let}~{##1} ={##2}~{\tt in} \\ {##3}\end{array}}
	\newcommand {\caseof} [3] {{\tt case(}{##1}{\tt ;}{##2}{\tt ;}{##3}{\tt )}}
	\newcommand {\tallcase} [3] {\begin{array}{@{}l@{}} {\tt case}~{##1} ~{\tt of}\\~~{##2}\\{\tt |}~{##3} \end{array}}
	\newcommand {\ifthen} [3] {{\tt if}~{##1} ~{\tt then}~{##2}~{\tt else}~{##3}}
	\newcommand {\tallif} [3] {\begin{array}{@{}l@{}} {\tt if}~{##1} \\{\tt then}~{##2}\\{\tt else}~{##3} \end{array}}
	\newcommand {\dothen} [3] {{\tt do}~{##1} ~{\tt then}~{##2}~{\tt =>}~{##3}}

	\newcommand {\lam} [3] [] {{\tt \lambda}_{##1}{\tt (}{##2}{\tt .}{##3}{\tt )}}
	\newcommand {\valprod} [2] {({##1},{##2})}
	\newcommand {\projbind} [1] {\letin{l_{##1}}{\pi_{##1} l}{r_{##1}}}
	\newcommand {\mval} [2] {{\tt mv(}{##1}{\tt ;}{##2}{\tt )}}
}
...
\newcommand {\istypem} {~{\rm type}~@~\bbem}
