...
\newcommand {\bbonep} {\ensuremath{\mathbbmss{1P}}}
...
{ 
	...
	\newcommand {\pipeM} [3] {\mytt{sepM(}{##1}\mytt{;}{##2}\mytt{.}{##3}\mytt{)}}
	\newcommand {\pipeS} [3] {\mytt{sep2(}{##1}\mytt{;}{##2}\mytt{.}{##3}\mytt{)}}
...
\newcommand {\splitone} 	[5] [\Gamma] {{#2} \splitonesym \mytt{sepM(}{#4}\mytt{;}{#5}\mytt{)}}
\newcommand {\splitonetall} [5] [\Gamma] {{#2} \splitonesym \mytt{sepM}\left(\begin{array}{@{}l@{}}{#4}\mytt{;}\\{#5}\end{array}\right)}
