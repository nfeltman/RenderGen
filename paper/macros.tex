...
{ 
	...
	\newcommand {\monoTerm} [1] {\mytt{mono(}##1\mytt{)}}
	\newcommand {\inl} [2] [] {\mytt{inl}_{##1}\mytt{(}{##2}\mytt{)}}
	\newcommand {\inr} [2] [] {\mytt{inr}_{##1}\mytt{(}{##2}\mytt{)}}
	\newcommand {\pio} [1] {\mytt{pi1(}##1\mytt{)}}
	\newcommand {\pit} [1] {\mytt{pi2(}##1\mytt{)}}
	\newcommand {\roll} [2] [] {\mytt{roll}_{##1}\mytt{(}##2\mytt{)}}
...
\newcommand {\sepredone} [2] {{#1} \Downarrow_\bbone^S {#2}}
