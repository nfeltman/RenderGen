...
\newcommand {\isvalone} [1] {\Xi \vdash {#1}~{\rm val}~@~\bbone}
...
\newcommand {\diaone} [3] [\Xi;\Gamma] {{#1} \vdash {#2} \Downarrow_\bbone [{#3}]}
\newcommand {\diatwo} [3] [\Xi;\Gamma] {{#1} \vdash {#2} \Downarrow_\bbtwo {#3}}
...
\newcommand {\splitone} [4] [\Gamma] {{#1} \vdash {#2}:{#3} \splitonesym \left[{#4}\right]}
\newcommand {\splittwo} [4] [\Gamma] {{#1} \vdash {#2}:{#3} \splittwosym \left[{#4}\right]}
...
\newcommand {\gcomp} [2] {\xi_{#1} \circ \xi_{#2}}
