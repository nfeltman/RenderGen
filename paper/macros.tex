...
{ 
	...
	\newcommand {\pure} [1] {\mytt{pure(}##1\mytt{)}}
	...
	\newcommand {\letp} [3] {\mytt{letp(}{##2}\mytt{;}{##1}.{##3}\mytt{)}}

	\newcommand {\caseof} [3] {\mytt{case(}{##1}\mytt{;}{##2}\mytt{;}{##3}\mytt{)}}
	\newcommand {\caseP} [3] {\mytt{caseP(}{##1}\mytt{;}{##2}\mytt{;}{##3}\mytt{)}}
	\newcommand {\pipeM} [3] {\mytt{pipeM(}{##1}\mytt{;}{##2}\mytt{.}{##3}\mytt{)}}
	\newcommand {\pipeS} [3] {\mytt{pipeS(}{##1}\mytt{;}{##2}\mytt{.}{##3}\mytt{)}}

	\newcommand {\app} [2] {\mytt{app}\mytt{(}{##1}\mytt{;}{##2}\mytt{)}}
	\newcommand {\lam} [2] {\mytt{fn}\mytt{(}{##1}\mytt{.}{##2}\mytt{)}}
	\newcommand {\valprod} [2] {({##1},{##2})}
	\newcommand {\projbind} [1] {\letin{l_{##1}}{\pi_{##1} l}{r_{##1}}}
	\newcommand {\mval} [2] {\mytt{mv(}{##1}\mytt{;}{##2}\mytt{)}}
...
%judgments
\newcommand {\colone} [2] {{#1}:{#2}~@~\bbonem}
\newcommand {\coltwo} [2] {{#1}:{#2}~@~\bbtwo}
\newcommand {\colmono} [2] {{#1}:{#2}~@~\bbmono}
\newcommand {\colmix} [2] {{#1}:{#2}~@~\bbonem}
\newcommand {\colpure} [2] {{#1}:{#2}~@~\bbonep}
...
\newcommand {\istypemix} {\ \mathsf{type}~@~\bbonem}
\newcommand {\istypetwo} {\ \mathsf{type}~@~\bbtwo}
\newcommand {\istypepure} {\ \mathsf{type}~@~\bbonep}
\newcommand {\istypewor} {\ \mathsf{type}~@~w}
