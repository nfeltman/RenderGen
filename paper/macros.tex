...
\newcommand {\diaone} [2] {{#1} \Downarrow_\bbone [{#2}]}
\newcommand {\diatwo} [2] {{#1} \downarrow {#2}}
...
\newcommand {\diaonesub} [1] [] {\diaone{e_{#1}}{\gamma_{#1},v_{#1}}}
...
%misc
\newcommand {\gcomp} [2] {\gamma_{#1} \circ \gamma_{#2}}
