...
computations can depend on stage \bbone, $r$ can depend on $p$ via the variable
$l$. The correctness of splitting thus requires that $e$ is equivalent to
$\letin l p r$. 

Splitting, as implemented by the judgment $e \splittwosym [p,l.r]$
...
\texttt{case} and functions gives rise to speculative execution of
precomputations from underneath binders.) The $\prev$ and $\pause$ rules depends
