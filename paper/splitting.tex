...
which is just a technical device to convert residual tables and partial values---like the those above---into a syntactically seperated version $\mathcal{V}$.
...
These expressions, as they contain no stage~\bbtwo\ subcomputations, have a trivial resumer, $\tup{}$.
