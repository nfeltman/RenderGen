...
We consider the two possible control paths seperately.  In the first case, 
...
\]
Additionally, the branch first evaluates $\diaone {[v_1/x_2]e_2} {\xi_2} {v_2}$ and $\rtab {\xi_2} {v_2} \vsplito \mval {i_2} {q_2}$.
Inductively,
\[
	\splitone {e_2} A {c_2} {l_2.r_2} \text{ and } \reduce {[i_1/x_2]e_2} {\tup{i_2,b_2}} \text{ and } [b_2/l_2](\letin x {q_1} {r_2}) \equiv q_2
\]
