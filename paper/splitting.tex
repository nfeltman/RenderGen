...
\begin{definition}
For residuals $q$ and $r$, define $q \equiv r$ to mean that 
$\diatwo {e_1} {v_1}$ iff $\reduce {e_2} {v_2}$ where .
\end{definition}

We give the following end-to-end correctness lemmas for closed terms (open term versions forthcoming).
