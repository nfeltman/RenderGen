...
resumer.  This logic occurs regardless of whether the terms forming
the branches of the \texttt{case} contain second stage computations.
...
we instead introduce world \bbonep\ and use the type system to
statically prove terms contain no second stage computations.  In these
situations, splitting is trivial---splitting $\pure e$ terms yields a
unit resumer.  
