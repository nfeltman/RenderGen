...
The goal of partial value splitting is to take a partial value $v$ and create from it two single stage values $v_1$ and $v_2$,
...
At base types, partial value splitting assigns all content ({\em i.e.} the integer or boolean) to stage \bbone, and uses a nullary tuple placeholder for stage \bbtwo.
...
In some of the theorems, we sort the usually heterogeneous context into $\Gamma$ and $\Gamma'$, 
