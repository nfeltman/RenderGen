...
statically prove certain terms contain no second stage computations.
In these situations, splitting is trivial---splitting $\pure e$ terms
yields a unit resumer.
