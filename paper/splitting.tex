...
Given an $\splittwo e ? p l r$ and $\diatwo e q$ for which the splitting invariant holds, we know
\[
	\reduce p b \text{ and } [b/l]r \equiv q
\]
The splitting invariant for $\splitone {\next {e'}} ? {c'} {l'.r'}$ 
and $\diaone {\next {e'}} {\yhat \mapsto q} {\next \yhat}$
and $\rtab {\yhat \mapsto q} {\next \yhat} \vsplito \mval {\tup{}} {\letin \yhat q \yhat}$
is
\[
	\reduce {c'} {\tup {\tup{},b'}} \text{ and } [b'/l']r' \equiv \letin \yhat q \yhat
\]
