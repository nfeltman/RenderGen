...
The stage splitting operation takes as input a \lang\ term which contains interleaved stage \bbone\ and stage \bbtwo\ code
and splits it into two separate terms: one with all of the stage \bbone\ code and one with all the stage \bbtwo\ code.  
