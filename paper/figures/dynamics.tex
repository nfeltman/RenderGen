...
\inferstepone	{\red {\pio {\exv{\tup{v_1,v_2}}}} {\exv{v_1}}} 										{\cdot} \and
\inferstepone	{\red {\pit {\exv{\tup{v_1,v_2}}}} {\exv{v_2}}} 										{\cdot} \and
\inferstepone	{\red {\app {\exv{\fix fxe}}{\exv v}} {[\fix fxe,v/f,x]e}} 											{\cdot} \and
...
\inferstepGT 	{\red {\inl{\exv v}} {\exv{\inl v}}} 													{\cdot} \and
\inferstepGT 	{\red {\inr{\exv v}} {\exv{\inr v}}} 													{\cdot} \and
...
\end{abstrsyn}
\caption{First pass evaluation of \lang.}
