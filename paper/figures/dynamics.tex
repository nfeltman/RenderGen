...
\inferstepone	{\stepmix {\letp x {\pure v} e} {[v/x]e}} 								{v \val} \and
\end{mathpar}
\hrule
\begin{mathpar}
\fbox{General Substeps}	\and
...
\inferstepw		{\red 	{\tup {e_1,e_2}} 
						{\tup {e'_1,e_2}}} 							
				{\sub {1}} \and
\inferstepone	{\red 	{\tup {\exv{v_1},e_2 }} 
						{\tup {\exv{v_1},e'_2}}} 								
				{\sub {2} & v_1 \val} \and
\infersteptwo	{\red 	{\tup {\exv{v_1},e_2 }} 
						{\tup {\exv{v_1},e'_2}}} 								
				{\sub {2} & v_1 \res} \and
...
\hrule
\begin{mathpar}
\fbox{Lifting Steps} \and
\inferlift 		{\red {\next q} {\next y}} {q \res & q {\rm not variable}} \and
\infersteptwo 	{\red {\prev e} {\letin q y e}} {\liftsub{}} \and
\inferlift		{\red 	{\pio e} 
						{\pio {e'}}} 											
				{\sub {}} \and
\inferlift		{\red 	{\pit e} 
