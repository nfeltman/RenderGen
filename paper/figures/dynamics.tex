...
\inferdiaone [\to E]  		{\red {e_1~e_2} {\gcomp 1 2 \circ \xi';v'}}					{\red {e_1} {\xi_1;\vallam{x}{e'}} & \sub [2] & \red [\Gamma,\dom{\xi_1},\dom{\xi_2}] {[v_2/x]e'}{\xi';v'}}	\and
%
...
%
\inferdiaone [+ E_1]  		{\red {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{\gcomp 1 2;v_2}}		{\red {e_1}{\xi_1;\valinl~v} & \red [\Gamma,\dom{\xi_1}]{[v/x_2]e_2}{\xi_2;v_2}} 					\and
\inferdiaone [+ E_2]  		{\red {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{\gcomp 1 3;v_3}}		{\red {e_1}{\xi_1;\valinr~v} & \red [\Gamma,\dom{\xi_1},\dom{\xi_1}]{[v/x_3]e_3}{\xi_3;v_3}}					\and
%
...
\inferdiaone [if_F]   		{\red {\ifthen{e_1}{e_2}{e_3}}{\gcomp 1 3;v}}					{\red {e_1}{\xi_1;\bf false} & \red {e_3}{\xi_3;v}}							\and
%
...
\inferdiaspc [\fut E]			{\red {\prev~e} q}													{\diaone e {\xi; \hat y} & \reify{\xi}{\hat y}q}							\and
