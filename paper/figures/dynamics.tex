...
%\begin{figure}
%\begin{mathpar}
%\inferreducewor [\to I]			{\redone {\lam{x}{A}{e}} {\lam{x}{A}{e}}}		{\cdot} 																		\and
%\inferreducewor [\to I]			{\redtwo {\lam{x}{A}{e}} {\lam{x}{A}{e}}}		{\specwor e} 																	\and
%\inferreducewor [\to E]			{\red {e_1~e_2} {v'}}								{\red {e_1} {\lam{x}{A}{M}} & \red{e_2}v & \red {[v/x]M} {v'}}			\and
%%
...
%%
%\inferreducewor [+ E_1]			{\redone {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{v'}}		{\redone {e_1}{\inl~v} & \redone {[v/x_2]e_2}{v'}} 					\and
%\inferreducewor [+ E_2]			{\redone {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{v'}}		{\redone {e_1}{\inr~v} & \redone {[v/x_3]e_3}{v'}}						\and
%\inferreducewor [+ E_1]			{\redtwo {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{v'}}		{\redtwo {e_1}{\inl~v} & \redtwo {[v/x_2]e_2}{v'} & \specwor {e_3}}	\and
%\inferreducewor [+ E_2]			{\redtwo {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{v'}}		{\redtwo {e_1}{\inr~v} & \redtwo {[v/x_3]e_3}{v'} & \specwor {e_2}}	\and
%%
...
%\inferreducewor [if_T] 			{\redone {\ifthen{e_1}{e_2}{e_3}}{v}}				{\redone {e_1}{\tt true}  & \redone {e_2}{v}} 								\and
%\inferreducewor [if_F] 			{\redone {\ifthen{e_1}{e_2}{e_3}}{v}}				{\redone {e_1}{\tt false} & \redone {e_3}{v}}								\and
%\inferreducewor [if_T] 			{\redtwo {\ifthen{e_1}{e_2}{e_3}}{v}}				{\redtwo {e_1}{\tt true}  & \redtwo {e_2}{v} & \specwor {e_3}}			\and
%\inferreducewor [if_F] 			{\redtwo {\ifthen{e_1}{e_2}{e_3}}{v}}				{\redtwo {e_1}{\tt false} & \redtwo {e_3}{v} & \specwor {e_2}}
%\end{mathpar}
...
%\inferreducewor [\fut E]			{\reducexpl \bbtwo \bbtwo {\prev~e} v}			{\reducexpl \bbone \bbtwo e {\next~v}} 									\and
...
%\inferRedsplitone [if_T] 		{\red {\ifthen{e_1}{e_2}{e_3}}{u}{(r_1;r_2)}}					{\red{e_1}{\tt true }{r_1} & \red{e_2}{u}{r_2}}	\and
%\inferRedsplitone [if_F] 		{\red {\ifthen{e_1}{e_2}{e_3}}{u}{(r_1;r_3)}}					{\red{e_1}{\tt false}{r_1} & \red{e_3}{u}{r_3}}	\and
...
%\begin{figure*}
%\begin{mathpar}
%\inferRedsplitone [\to I]	{\red {\lam{x}{A}{e}}{\lam{x}{A}{e}}{()}}			{\cdot} 																\and
%\inferSpeculation [\to I]	{\red {\lam{x}{A}{e}}{\lam{x}{A}{r}}}				{\sub} 																	\and
%\inferRedsplitone [\to E]	{\red {e_1~e_2}{v'}{(r_1;\letin{x}{r_2}{r'})}}		{\red {e_1}{\lam{x}{A}{M}}{r_1} 
%																							& \sub [2] & \red{[[e,x]/x]M}{v'}{r'}} 							\and
%\inferSpeculation [\to E]	{\red {e_1~e_2}{r_1~r_2}}							{\sub [1] & \sub[2]}													\and
%\inferRedsplitone [+ I_1]	{\red {\inl~e} {\inl~v}{r}}						{\sub} 																	\and
%\inferSpeculation [+ I_1]	{\red {\inl~e} {\inl~r}}							{\sub} 																	\\
%\inferRedsplitone [+ I_2]	{\red {\inr~e} {\inr~v}{r}}						{\sub} 																	\and
%\inferSpeculation [+ I_2]	{\red {\inr~e} {\inr~r}}							{\sub} 																	\\
%\inferRedsplitone [+ E_1]	{\red {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{v'}
%								{\letin{x_2}{r_1}{r_2}}}								{\red {e_1}{\inl~v}{r_1} & \red {[[v,x_2]/x_2]e_2}{v'}{r_2}} \and
%\inferRedsplitone [+ E_1]	{\red {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{v'}
%								{\letin{x_3}{r_1}{r_3}}}								{\red {e_1}{\inr~v}{r_1} & \red {[[v,x_3]/x_3]e_3}{v'}{r_3}} \and
