...
\infertypeswor [\monoType I] {\typesone {\monoTerm~e} {\monoType A}}					{\typesmono e A} 																\and
\infertypeswor [\monoType E] {\typesone {\letmono x {e_1} {e_2}} B}					{\typesone {e_1} {\monoType A} & \typesone [\Gamma,\colmono x A] {e_2} B} 		\and
\infertypeswor [lift] {\typesone {\lifttag~e} {\monoType A + \monoType B}}	{\typesone e {\monoType (A+B)}} 												\and
\infertypeswor [hold]			{\typesone {\pause~e} {\fut \rmint}}				{\typesone e {\monoType \rmint}}		 													\and
\end{mathpar}
