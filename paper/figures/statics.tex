...
\infertypeswor [int]		{\Delta \vdash {\tt int} \istypewor}						{w = \bbonep,\bbtwo} 														\and
...
\infertypeswor [int]		{\ty {i} \rmint}									{w = \bbonep,\bbtwo} 														\and
...
% \infertypeswor [\to E]		{\ty {\app {e_1}{e_2}} {\curr B}}					{\ty {e_1} {\curr(A \to B)} & \ty {e_2} {\curr A}} 							\and
% \infertypeswor [\times E_1]	{\ty {\pio e} {\curr A}}							{\ty e {\curr(A\times B)}}													\and
% \infertypeswor [\times E_2]	{\ty {\pit e} {\curr B}}							{\ty e {\curr(A\times B)}}													\and
