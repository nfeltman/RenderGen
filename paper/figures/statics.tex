...
\infertypeswor [\to I]		{\ty {\lam [A]{x}{e}} {A \to B}}					{A \istypewor & \ty [,\col x A] e B} 											\and
...
\infertypeswor [+ I_1]		{\ty {\inl [A+B] e} {A + B}}					{\ty e A} 																		\and
\infertypeswor [+ I_2]		{\ty {\inr [A+B] e} {A + B}}					{\ty e B} 																		\and
\infertypeswor [+ E]		{\ty {\caseof{e_1}{x_2.e_2}{x_3.e_3}} C}		{\ty {e_1}{A+B} & \ty[,\col {x_2} A]{e_2} C & \ty[,\col {x_3} B]{e_3} C} 		\and
\infertypeswor [\mu I]		{\ty {\roll [\mu \alpha.\tau] e} 
...
\infertypeswor [\curr I]	{\typesone {\monoTerm e} {\curr A}}				{\typesmono e A} 																\and
\infertypeswor [\curr E]	{\typesone {\letmono x {e_1} {e_2}} B}			{\typesone {e_1} {\curr A} & \typesone [\Gamma,\colmono x A] {e_2} B} 			\and
