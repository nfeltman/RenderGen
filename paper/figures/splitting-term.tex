...
\infersplitone [hyp]			{\spl {x}{A}{(x,()),\_.x}}																	{\col x A \in \Gamma} \and
...
\infersplitone	 [\to I]	{\spl {\lam{x}{A}{e}}{A \to B}{\lam{x}{A}{c},
							\_.(\lam{(x,l)}{\_}{r})}}																			{\sub [\Gamma,\col x A] {} B} 									\and
...
\infersplitone [+ E]		{\spl {\left(\tallcase{e_1}{x_2.e_2}{x_3.e_3}\right)}{C}
								...
								(l_1,l_b).\left(\talllet{z}{r_1}{
									\tallcase{l_b}
									{l_2.\letin{x_2}{z}{r_2}}
									{l_3.\letin{x_3}{z}{r_3}}}\right)\end{array}}}				{\sub 1 {A+B} & \sub [\Gamma,\col{x_2} A] 2 C 	& \sub [\Gamma,\col{x_3} B] 3 C} 	\and
%
\infersplitone [\mu I]		{\spl {\roll~e}{\mu\alpha.\tau}{\talllet{(y,z)}{c}{(\roll~y,z)},l.\roll~r}}						{\sub {} {[\mu\alpha.\tau/\alpha]\tau}}							\and
\infersplitone [\mu E]		{\spl {\unroll~e}{[\mu\alpha.\tau/\alpha]\tau}{\talllet{(y,z)}{c}{(\unroll~y,z)},l.\unroll~r}}	{\sub {} {\mu\alpha.\tau}}										\and
%
...
\infersplittwo [+ E]			{\spl {\left(\tallcase{e_1}{x_2.e_2}{x_3.e_3}\right)}{C}
								{(p_1,p_2,p_3), (l_1,l_2,l_3).\left(\tallcase{r_1}
									{x_2.r_2}{x_3.r_3}\right)}}				{\sub 1 {A+B} & \sub [\Gamma,\col{x_2} A] 2 C 
																									& \sub [\Gamma,\col{x_3} B] 3 C} 								\and
\infersplittwo [\mu I]		{\spl {\roll~e}{\mu\alpha.\tau}{l.\roll~r}}												{\sub {} {[\mu\alpha.\tau/\alpha]\tau}}							\and
\infersplittwo [\mu E]		{\spl {\unroll~e}{[\mu\alpha.\tau/\alpha]\tau}{l.\roll~r}}								{\sub {} {\mu\alpha.\tau}}										\and
