...
The grammar of \lang\ can be found in \cref{fig:grammar}.

\subsection{Statics}
The grammar and type system of \lang\ are a simple adaptation of those of \cite{davies96}, 
restricted to two stages\footnote{This restriction to two stages is made primarily for 
simplicity of presentation.  All of these techniques could feasibly be extended to more
complicated stage systems.} and extended with general sums and recursion.

As explained before, the $\fut$ constructor is a way to encapsulate a stage \bbtwo\ type at stage \bbone.  
