...
and we surround their arguments with \{braces\} in the concrete syntax to clearly indicate the stage boundaries with in a program.
...
We annotate the typing judgment and context variables with stages; only $\fut$
and its introductory and eliminatory forms $\next$ and $\prev$ affect the stage
of a term or type.
...
Ignoring for the moment how to define recursive functions in \lang, we can
implement staged fast exponentiation as follows:%
