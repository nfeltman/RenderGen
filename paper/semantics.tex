...
This judgment, upon encountering a stage \bbtwo\ subexpression, must necessarily search into it in order to find its stage
\bbone\ subexpressions; we call this process \emph{speculation}. 
Speculation is implemented by the $\redtwosym$ judgment, which takes a stage \bbtwo\ term to a residual.
