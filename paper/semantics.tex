...
% As our concern is stage splitting of explicitly staged programs expressed in \lang.
...
%The problem of how to convert an unstaged program into a staged one by inserting these constructs is called {\em binding time analysis}.
