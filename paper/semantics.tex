...
\begin{figure}
\caption{\ellStaged~Straw Dynamic Semantics}
...
\inferreducewor [\to I]			{\red {\lam{x}{A}{e}} {\vallam{x}{M}}}			{\cdot} 																		\and
...
\inferreducewor [\times I]		{\red {(e_1,e_2)}{\valprod{v_1}{v_2}}}			{\sub [1] & \sub [2]} 														\\
...
\inferreducewor [+ E_1]			{\red {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{v'}}	{\red {e_1}{\valinl~v} & \red {[v/x_2]e_2}{v'}} 							\and
\inferreducewor [+ E_2]			{\red {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{v'}}	{\red {e_1}{\valinr~v} & \red {[v/x_3]e_3}{v'}} 							\and
\inferreducewor [if_T] 			{\red {\ifthen{e_1}{e_2}{e_3}}{v}}				{\red{e_1}{\bf true}  & \red{e_2}{v}} 										\and
\inferreducewor [if_F] 			{\red {\ifthen{e_1}{e_2}{e_3}}{v}}				{\red{e_1}{\bf false} & \red{e_3}{v}}										\and
...
\inferreducespc [if_T] 			{\red {\ifthen{e_1}{e_2}{e_3}}}				{\sub [1] & \sub [2] & \sub [3]} 	\and
\inferreducespc [\fut E]			{\red {\prev~e}}								{\reducexpl \bbone \bbtwo e {DUM}} 	\and
\end{mathpar}
\end{figure}
