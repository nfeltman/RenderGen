...
\lang\ is largely based off of a language defined in \cite{davies96} 
...
definition above, it is in fact a staged program. The function receives a stage-\bbone\ exponent {\tt e} and a stage-\bbtwo\ base {\tt b} and returns stage-\bbtwo\ result. The {\tt if} predicates and exponent
...
Here, $x$ is the static input, $y$ is the dynamic input, and $f_x$ is residual, also called ``f specialized to x."
