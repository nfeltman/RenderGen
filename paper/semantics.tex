...
\begin{figure}
\caption{\ellStaged~Dynamic Semantics (Core)}
\label{fig:erasureSemanticsCore}
\begin{mathpar}
\inferreducewor [\to I]			{\redone {\lam{x}{A}{e}} {\vallam{x}{M}}}		{\cdot} 																		\and
\inferreducewor [\to I]			{\redtwo {\lam{x}{A}{e}} {\vallam{x}{M}}}		{\specwor e} 																	\and
...
\inferreducespc [\fut E]			{\red {\prev~e}}									{\reducexpl \bbone \bbtwo e {DUM}} 								
\end{mathpar}
\end{figure}	

\begin{figure}
\caption{\ellStaged~Dynamic Semantics (Sums and Products)}
\label{fig:erasureSemanticsSumProd}
\begin{mathpar}
...
\begin{figure}
\caption{\ellStaged~Dynamic Semantics (Derivable Constructs)}
\label{fig:erasureSemanticsExtra}
\begin{mathpar}
...
\inferreducewor [if_F] 			{\redtwo {\ifthen{e_1}{e_2}{e_3}}{v}}				{\redtwo {e_1}{\bf false} & \redtwo {e_3}{v} & \specwor {e_2}}			\and
