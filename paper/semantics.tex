...
\crem{Do we actually want to make this ``more efficient'' claim?}
...
\crem{Need to explain why we chose letp and caseP as the abstractions. Then
explain hold.}

\crem{Need to explain why \bbonem\ doesn't have ints.}
