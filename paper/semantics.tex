...
\inferdiaone [\to E]  		{\red {e_1~e_2} {\gcomp 1 2 \circ \xi',v'}}					{\red {e_1} {\xi_1,\vallam{x}{e'}} & \sub [2] & \red {[v_1/x]e'}{\xi',v'}}	\and
%
...
%
\inferdiaone [+ E_1]  		{\red {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{\gcomp 1 2,v_2}}		{\red {e_1}{\xi_1,\valinl~v} & \red {[v/x_2]e_2}{\xi_2,v_2}} 					\and
\inferdiaone [+ E_2]  		{\red {\caseof{e_1}{x_2.e_2}{x_3.e_3}}{\gcomp 1 2,v_3}}		{\red {e_1}{\xi_1,\valinr~v} & \red {[v/x_3]e_3}{\xi_3,v_3}}					\and
%
\inferdiaone [int]			{\red {i}{\cdot,i}}												{\cdot} 																					\and
\inferdiaone [bool]   		{\red {b}{\cdot,b}}												{\cdot} 																					\and
\inferdiaone [let]			{\red {\letin{x}{e_1}{e_2}}{\gcomp 1 2, v_2}}					{\sub [1] & \red{[v_1/x]e_2}{\xi_2,v_2}}											\and
\inferdiaone [if_T]   		{\red {\ifthen{e_1}{e_2}{e_3}}{\gcomp 1 2,v}}					{\red {e_1}{\xi_1,\bf true}  & \red {e_2}{\xi_2,v}} 							\and
\inferdiaone [if_F]   		{\red {\ifthen{e_1}{e_2}{e_3}}{\gcomp 1 2,v}}					{\red {e_1}{\xi_1,\bf false} & \red {e_3}{\xi_3,v}}								
\end{mathpar}
