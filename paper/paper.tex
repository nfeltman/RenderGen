...
\infersplitone [let]			{\spl {\letin{x}{e_1}{e_2}}{B}{
								...
								\end{array}}}																					{\sub 1 A & \sub [\Gamma,x:A^\bbone] 2 B} \and
...
\label{fig:advancedTypes}
\begin{mathpar}
\inferRedsplitone [\to I]	{\red {\lam{x}{A}{e}}{\vallam{x}{e}}{()}}			{\sub} 																	\and
...
\infersplitone	 [\to I]	{\spl {\lam{x}{A}{e}}{A \to B}{\vallam{x}{c},
							\_.(\vallam{y}{\letin{x}{\pi_1 y}{\letin{l}{\pi_2 y}{r}}})}}		{\sub [\Gamma,x:A^\bbone] {} B} 						\and
\infersplittwo [\to I]	{\spl {\lam{x}{A}{e}}{A \to B}{p,l.(\vallam{x}{M})}}				{\sub [\Gamma,x:A^\bbtwo] {} B} 						\and
...
\infersplitone [+ E]		{\spl {\left(\tallcase{e_1}{x_2.e_2}{x_3.e_3}\right)}{C}
								...
								l.\left(\talllet{z}{(\projbind 1)}{
									\tallcase{\pi_2 l}
									{l_2.\letin{x_2}{z}{r_2}}
									{l_3.\letin{x_3}{z}{r_3}}}\right)\end{array}}}				{\sub 1 {A+B} & \sub [\Gamma,x_2:A^\bbone] 2 C 
																									& \sub [\Gamma,x_3:A^\bbone] 3 C} 						\and
\infersplittwo [+ E]		{\spl {\left(\tallcase{e_1}{x_2.e_2}{x_3.e_3}\right)}{C}
								{(p_1,p_2,p_3), l.\left(\tallcase{(\projbind 1)}
									{x_2.\projbind 2}{x_3.\projbind 3}\right)}}				{\sub 1 {A+B} & \sub [\Gamma,x_2:A^\bbtwo] 2 C 
																									& \sub [\Gamma,x_3:A^\bbtwo] 3 C} 						\and
\end{mathpar}
\end{figure*}
